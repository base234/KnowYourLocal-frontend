...
export default function Help() {
  ...
  const faqItems = [
    {
      ...
      answer:
        'To create your first local, click the "New Local" button in the sidebar, fill in the details about your location, and save it. You can add photos, descriptions, and tags to make it more discoverable.',
    },
    {
      id: 2,
      category: "locals",
      ...
      answer:
        'Yes! You can edit or delete your locals anytime. Go to "My Locals", find the local you want to modify, and use the options menu to edit or delete it.',
    },
    {
      id: 3,
      category: "account",
      ...
      answer:
        'Click on your profile icon in the top-right corner, select "Settings" from the dropdown menu, and you can update your personal information, preferences, and privacy settings.',
    },
    {
      id: 4,
      category: "technical",
      ...
      answer:
        "Try refreshing the page first. If the issue persists, clear your browser cache, check your internet connection, or try using a different browser. Contact support if problems continue.",
    },
    {
      id: 5,
      category: "locals",
      ...
      answer:
        "Make sure to add detailed descriptions, relevant tags, and high-quality photos to your locals. Set appropriate privacy settings and consider sharing them on social media.",
    },
    {
      id: 6,
      category: "getting-started",
      ...
      answer:
        "You can create various types of locals including restaurants, parks, shops, entertainment venues, work spaces, and any other location that might be interesting or useful to others.",
    },
  ];
  ...
  return (
    <div className="max-w-7xl space-y-6">
      <h1 className="text-2xl font-bold text-gray-900">Help and Support</h1>
